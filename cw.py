...
a_route = [[10,0],[3,5],[5,8]] 
b_route = [[3,0],[9,1],[4,10],[12,2],[6,1],[7,10]]
c_route = [[3,0],[9,1],[4,8],[12,2],[6,1],[7,8]]

def bus(list):
    seats = 0
    for x in list: # for loop for each bus stop
        seats += x[0] # people getting on bus
        seats -= x[1] # people getting off bus
    print(f"The bus has {seats} filled at the end of the route") # outputting the amount of people still left on the bus
